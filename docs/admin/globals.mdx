...
| **`elements.DeleteDocument`**  | Replace the default Delete Button with a Custom Component. User must have [Delete](../access-control/collections#delete) access on the global.                                          |
